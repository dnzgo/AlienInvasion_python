...
def run_game():
    ...
    # main game loop
    while True:
        game_functions.check_events(game_settings, game_stats, screen, ship, aliens, bullets, play_button) # check events like keypress and mouse events
        ...
        game_functions.update_screen(game_settings, game_stats, screen, ship, aliens, bullets, play_button) # Update images on the screen and flip to the new screen.
